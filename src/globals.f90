...
! integration control and parameters
  integer :: nint_order, maxsub, integrator, contour_select, ineq, int_counter, nint_order_el
  real(dp) :: epsfermi, delta_imag, eps_int, elow, eps_int_contour
...
! transport parameters bias,temperature,chemical potentials
  real(dp) :: vb, mul, mur, temperature_el, ef_l, ef_c, ef_r, vl, vr
...
! transport control
  ...
  character(strln), allocatable :: species_ecc(:), species_elec_l(:), species_elec_r(:)
