...
!~       call PetscPrintf(PETSC_COMM_WORLD,"          ",ierr)
  ...
  subroutine adaptive_int3_scalar(f, a, b, p_zint1, p_zint2, nsub, eps, abserr)
    ...
    complex(dp) :: p_zint1, p_zint2, p_tmp1_int1, p_tmp1_int2, p_tmp1_int3,&
    &p_tmp2_int1, p_tmp2_int2, p_tmp2_int3
    ...
    i = 0
    call evalqr_scalar(f, subint(1, 1), subint(2, 1), nodes, w1, w2, p_tmp1_int1, p_tmp2_int1, nint_order, nlow, error_1, error_2, subdiv(1, 1), subdiv(2, 1))
    errorg = 0d0
    suberr(1) = max(error_1, error_2)
    subcurrent(1:2, 1) = subint(1:2, 1)
    p_zint1 = p_zint1 + p_tmp1_int1
    ...
    do
      ...
      if (all(subcurrent(1:2, 1) - subint(1:2, 1) .eq. 0)) then
        ...
        p_zint1 = p_zint1 - p_tmp1_int2
      else if (all(subcurrent(1:2, 3) - subint(1:2, 1) .eq. 0)) then
        p_zint1 = p_zint1 - p_tmp1_int3
      else
        call evalqr_scalar(f, subint(1, 1), subint(2, 1), nodes, w1, w2, p_tmp1_int1, p_tmp2_int1, nint_order, nlow, error_1, error_2, subdiv(1, 1), subdiv(2, 1))
        p_zint1 = p_zint1 - p_tmp1_int1
      end if
...
! a..a+1/3
      call evalqr_scalar(f, subint(1, i1), subint(2, i1), nodes, w1, w2, p_tmp1_int1, p_tmp2_int1, nint_order, nlow, error_1, error_2, subdiv(1, i1), subdiv(2, i1))
      suberr(i1) = max(error_1, error_2)
      p_zint1 = p_zint1 + p_tmp1_int1

! a+1/3*d..a+2/3*d
      call evalqr_scalar(f, subint(1, i2), subint(2, i2), nodes, w1, w2, p_tmp1_int2, p_tmp2_int2, nint_order, nlow, error_1, error_2, subdiv(1, i2), subdiv(2, i2))
      suberr(i2) = max(error_1, error_2)
      p_zint1 = p_zint1 + p_tmp1_int2

! a+2/3d..a+3/3*d=b
      call evalqr_scalar(f, subint(1, i3), subint(2, i3), nodes, w1, w2, p_tmp1_int3, p_tmp2_int3, nint_order, nlow, error_1, error_2, subdiv(1, i3), subdiv(2, i3))
